...
def main():
    ...
    output_dir = repo_dir / "results" / "greek_tourism" / "timesfm"
    ...
    # Generate Plots
    print(f"Generating plots for TimesFM (greek_tourism)...")
    for indicator, regions in plot_data_dict.items():
        ...
        for i, reg in enumerate(regions):
            ...
            plt.title(f"{indicator} - {reg['geo']} (Model: timesfm, greek_tourism)")
    ...
    print(f"TimesFM results for greek_tourism saved to {output_dir}")
