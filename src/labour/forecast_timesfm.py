...
def main():
    ...
    output_dir = repo_dir / "results" / "labour" / "timesfm"
    ...
    # Generate Plots
    print(f"Generating plots for TimesFM (labour)...")
    for indicator, regions in plot_data_dict.items():
        ...
        for i, reg in enumerate(regions):
            ...
            plt.title(f"{indicator} - {reg['geo']} (Model: timesfm, labour)")
    ...
    print(f"TimesFM results for labour saved to {output_dir}")
