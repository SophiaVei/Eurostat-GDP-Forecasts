...
def main():
    ...
    output_dir = repo_dir / "results" / "economy" / "timesfm"
    ...
    for indicator in indicators:
        ...
        train_idx, test_idx = train_eval_df.index, None
    ...
    # Generate Plots
    print(f"Generating plots for TimesFM (economy)...")
    ...
    print(f"TimesFM results for economy saved to {output_dir}")
